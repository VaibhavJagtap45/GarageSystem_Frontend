...
function ServiceNav() {
  return (
    <ServiceStack.Navigator screenOptions={{ headerShown: false }}>
      <ServiceStack.Screen name="ServiceHome" component={ServiceScreen} />
      <ServiceStack.Screen name="CounterSale" component={CounterSaleScreen} />
      <ServiceStack.Screen name="InvoiceDetail" component={InvoiceDetailScreen} />
...
function MoreNav() {
  return (
    <MoreStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <MoreStack.Screen name="CustomerRepairOrder" component={CustomerRepairOrderScreen} />
      <MoreStack.Screen name="CreateCustomerVehicle" component={CreateCustomerVehicleScreen} />
      <MoreStack.Screen name="CancelledOrders" component={CancelledOrdersScreen} />
      <MoreStack.Screen name="TallyExport" component={TallyExportScreen} />
      <MoreStack.Screen name="IncomeExpenseReport" component={IncomeExpenseReportScreen} />
